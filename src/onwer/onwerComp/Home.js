          ...
          <div id="collapseMenu"
            ...
            <ul
              ...
              <li className='max-lg:border-b max-lg:py-3'><a href='javascript:void(0)'
                  className='hover:text-blue-600 text-[15px] font-boldblock'><Link to={'/onwer'}>Home</Link></a></li>
              <li className='group max-lg:border-b max-lg:py-3 relative'>
                ...
                <ul
                  ...
                  <li className='border-b py-2 '><a href='javascript:void(0)'
                      className='hover:text-[#007bff] text-gray-600 text-[15px] font-bold block'><Link to="/addRoom">Add Room Detal</Link></a></li>
                  <li className='border-b py-2 '><a href='javascript:void(0)'
              ...
              <li className='max-lg:border-b max-lg:py-3'><a href='javascript:void(0)'
                  className='hover:text-[#007bff] text-gray-600 text-[15px] font-bold block'>xxxxxxxx</a></li>
              <li className='max-lg:border-b max-lg:py-3'><a href='javascript:void(0)'
                  className='hover:text-[#007bff] text-gray-600 text-[15px] font-bold block'>About</a></li>
              <li className='max-lg:border-b max-lg:py-3'><a href='javascript:void(0)'
                  className='hover:text-[#007bff] text-gray-600 text-[15px] font-bold block'>Contttact</a></li>
            </ul>
          </div>
